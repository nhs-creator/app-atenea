        ...
        >
          ...
          {activeTab === 'inventory' && (
            <div className="max-w-7xl mx-auto animate-in fade-in duration-500">
              <InventoryView inventory={atenea.inventory} config={config} onAdd={atenea.addInventory} onUpdate={atenea.updateInventory} onDelete={atenea.deleteInventory} onGenerateLabel={atenea.generateInventoryLabel} onPrintLabel={atenea.printInventoryLabel} />
            </div>
          )}
  ...
  return (
    ...
    <div className="h-[100dvh] flex flex-col overflow-hidden bg-slate-50 font-sans text-slate-800">
      ...
      <div className="max-w-md mx-auto p-4">
        ...
        {activeTab === 'inventory' && userRole === 'owner' && <InventoryView inventory={atenea.inventory} config={config} onAdd={atenea.addInventory} onUpdate={atenea.updateInventory} onDelete={atenea.deleteInventory} onGenerateLabel={atenea.generateInventoryLabel} onPrintLabel={atenea.printInventoryLabel} />}
