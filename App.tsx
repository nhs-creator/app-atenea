        ...
        >
          ...
          {activeTab === 'inventory' && (
            <div className="max-w-7xl mx-auto animate-in fade-in duration-500">
              <InventoryView inventory={atenea.inventory} config={config} onAdd={atenea.addInventory} onUpdate={atenea.updateInventory} onDelete={atenea.deleteInventory} onGenerateLabel={atenea.generateInventoryLabel} />
            </div>
          )}
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-32 font-sans text-slate-800">
      ...
      <main className="max-w-md mx-auto p-4">
        ...
        {activeTab === 'inventory' && userRole === 'owner' && <InventoryView inventory={atenea.inventory} config={config} onAdd={atenea.addInventory} onUpdate={atenea.updateInventory} onDelete={atenea.deleteInventory} onGenerateLabel={atenea.generateInventoryLabel} />}
