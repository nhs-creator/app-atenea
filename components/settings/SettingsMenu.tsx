...
export const SETTINGS_SECTIONS: SectionMeta[] = [
  ...
  { key: 'accountants', title: 'Usuarios', description: 'Creá una cuenta para tu contadora (o futuros empleados) con email y contraseña', icon: UserPlus, iconColor: 'text-indigo-500' },
