...
import { Save, List, Plus, Trash2, Ruler, Store, UserPlus, X, FileBarChart, Pencil, Check, ShieldCheck } from 'lucide-react';
...
const SettingsView: React.FC<SettingsViewProps> = ({ config, onSaveConfig }) => {
  ...
  // --- AFIP: configuración fiscal para emitir Factura C ---
  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      {/* 4. Configuración AFIP (Factura C) */}
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <div className="p-4 border-b border-slate-100 bg-slate-50/50">
          <h3 className="font-bold text-slate-700 flex items-center gap-2">
          ...
          <p className="text-xs text-slate-500 mt-1">CUIT, punto de venta y credenciales para emitir Factura C con CAE real.</p>
        </div>
        <div className="p-4 space-y-3">
